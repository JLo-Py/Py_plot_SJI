...
def plot_sji(sjimap, show_time = True, log = True, aspect = 'auto', mode = 'extent', **kwargs):
    ...
    # caution: aspect = 'auto' will force the image to a fixed aspect ratio depending on the size of the axis box. Use aspect = 'equal' to preserve original dimensions of the plotted map
